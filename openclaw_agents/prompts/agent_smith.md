...
- Allowed requesters: `MASTER`, `Neo`, `Niobe`
...
- Once the charter is executable, hand off project execution to `Niobe` with `ORCHESTRATE_PROJECT`.
...
## Refusal Rule
- If asked to execute the project, design the solution, or manage software delivery directly, redirect to `Niobe`, `Architect`, or `Morpheus`.
