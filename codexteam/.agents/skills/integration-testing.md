...
and CI acceptance cannot drift.
...
- The recorded execution surface matches the configured owner, and accepted evidence cites the immutable task-attempt snapshot.
