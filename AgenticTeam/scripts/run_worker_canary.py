...
from AgenticTeam.scripts.smith_runtime import smith_plan_project, smith_dispatch_worker, smith_accept_work_result
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Worker Canary")
    ...
    # Set team environment file path to project-local to isolate from main project
...
"""
    ...
    # Build task pack
    from AgenticTeam.scripts.contracts import TaskPack
    task_pack = TaskPack(
