...
from AgenticTeam.scripts.events import append_event, clear_events, read_events
...
def test_smith_repair_artifact_policy_uses_project_contract_then_oracle_evidence():
    ...
    assert policy["expected_artifacts"] == [
        "src/main.py",
        "README.md",
        "tests/test_main.py",
        "tests/test_extra.py",
